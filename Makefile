TARGET = TCC_EduardoDeOliveiraCastro.pdf
...
CHAPTERS_SOURCES = 1-introducao.tex  2-fundamentacao_teorica.tex 3-metodologia.tex \
									 4-resultados.tex  5-conclusoes.tex 6-apendices.tex 7-anexos.tex
