...
\begin{figure}[!htb]
\centering
\includegraphics{figuras/mapa_conceitual_tel_aviv}
...
\begin{figure}[!htb]
\centering
\includegraphics{figuras/mapa_conceitual_sao_paulo}
\caption{Mapa do Ecossistema de Tel-Aviv, Israel}
\label{Rotulo}
\end{figure}
...
As perguntas da subseção anterior visam responder as seguintes Questões de Pesquisa que representam o objetivo final e motivação deste trabalho como um primeiro passo para conhecer e mensurar o Ecossistema de Startups do Distrito Federal.
