...
Como descrito no paper ``Towards a Software Startup Ecosystems Maturity Model''~\citeonline{kon2015} a metodologia criada por pesquisadores da Universidade de São Paulo não tem como única utilidade
