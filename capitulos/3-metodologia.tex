...
Após a realização de cada Entrevista é recomendado que o Entrevistador faça a Codificação de Dados em uma tabela pontuando os pontos-chave o mais rápido possível, de forma a ainda possuir em sua memória boa parte das informações obtidas de cada Entrevistado.
...
\begin{itemize}
  \item Pergunta 00: Você poderia me contar um pouco da sua trajetória? Como se tornou um empreendedor? Quais as suas motivações? 
  \item Pergunta 01: Quais são as características de um Empreendedor da área de tecnologia? Você enxerga isso no brasíliense médio? Quais as principais motivações dos empreendedores do DF? Dinheiro? Fama? Autoestima?
  \item Pergunta 06: Quais são as características de times de sucesso? Pessoas com diferentes backgrounds se complementam? Diversidade é importante? Como? Qual seria a combinação ideal? Qual a sua visão sobre os times que são formados no Distrito Federal?
  \item Pergunta 00: O que faz a sua Startup? Em que fase ela está? Como tem sido sua experiência hoje? Como foi o começo? Já captou algum investimento? Já tem clientes? Como foi o processo para capta-los? De alguma forma o Ecossistema contribuiu para o crescimento da sua startup?
  \item Pergunta 07: Como lida com as dívidas técnicas? Como o Ecossistema contribui com a formação e o crescimento do seu time? 
  \item Pergunta 01: Quais são os fatores que promovem ou inibem a criação de um espírito empreendedor no Distrito Federal?
  \item Pergunta 02: Quais são os fatores que desencorajam ou criam barreiras para o empreendedor no Distrito Federal? E os que encorajam?
  \item Pergunta 03: Quais são os mecânismos institucionais do Distrito Federal que promovem ou inibem o empreendedorismo? Legislações, ações de universidades, ações do governo, ONGs, etc.
  \item Pergunta 04: Qual o papel da Educação na formação do Empreendedor? Como ela acontece no Distrito Federal? Você pode indicar iniciativas que alimentam o espírito empreendedor nos estudantes? Você já participou de alguma atividade de educação empreendedora enquanto estudante? Quais elementos poderiam ser melhorados na formação educacional dos jovens com objetivo de fomentar o empreendedorismo no Distrito Federal?
