...
Após a realização de cada entrevista a transcrição e codificação das entrevistas fora feita utilizando o software ``\textit{MAXQDA}''\footciteref{MaxQDA}, trata-se de um software proprietário, pago, e que fora recomendado por um dos criadores da metodologia, o Dr. Daniel Cukier. 
