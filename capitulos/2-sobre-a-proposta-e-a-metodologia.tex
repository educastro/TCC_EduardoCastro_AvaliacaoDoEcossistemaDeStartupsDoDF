...
A Figura \ref{figure:maxqda} representa a transcrição de uma das entrevistas realizadas no software mencionado, foram criadas etiquetas para cada uma das Questões exploradas no Capítulo \ref{subsection:questoes_de_pesquisa} que foram utilizadas como marcações no texto, possibilitando seu resgate de forma segmentada a qualquer momento afim de facilitar a análise posterior dos dados. 